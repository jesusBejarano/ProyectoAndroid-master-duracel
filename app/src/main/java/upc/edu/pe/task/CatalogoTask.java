...
*/
            ...
            prod.setNombre("Cerveza Corona");
            prod.setPrecio(20.60);
            prod.setImagen("corona.png");

            listProductos.add(prod);

            prod = new Producto();
            prod.setId_producto(2);
            prod.setNombre("Appleton");
            prod.setPrecio(220.60);
            prod.setImagen("appleton.png");
            listProductos.add(prod);
